...
class StationFaits():
    ...
    def __str__(self):
        return (f"StationFaits(id={self.id}, nb_bornettes={self.nb_bornettes}, velos_dispos={self.velos_dispos},meca_dispo={self.meca_dispo}, 
                elec_dispo={self.elec_dispo}, retour_velo={self.retour_velo}, frequence={self.frequence}, date_fait_deb={self.date_fait_deb}, 
                date_fait_fin={self.date_fait_fin})")
